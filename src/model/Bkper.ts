...
export class Bkper {
   ...
   */
  public async getBook(id: string, includeAccounts?: boolean, includeGroups?: boolean): Promise<Book> {
    let book = await BookService.loadBook(id, includeAccounts, includeGroups);
